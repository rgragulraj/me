...
- **Automated Data Processing**: AI algorithms automatically sort and clean uploaded retail data
- **Visual Analytics**: Comprehensive dashboard with visual representations of business metrics
- **Small-Scale Retail Focus**: Designed specifically for the needs of small retail shops
- **User-Friendly Interface**: Intuitive dashboard that doesn't require technical knowledge

### My Contribution

I developed this project independently as a side project to:
- Explore AI development from a developer perspective
...
![Project Canopy Dashboard 2](./Vite%20+%20React1_page-0001.jpg)

## Resources

- [GitHub Repository](https://github.com/Tiny-Jungle/tj_canopy)
